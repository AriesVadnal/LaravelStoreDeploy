...
Route::group(['auth','middleware'], function(){
    ...
    Route::post('/dashboard/products/gallery/upload','DashboardProductController@galleryUpload')->name('dashboard-products-gallery-upload');
    Route::get('/dashboard/products/gallery/delete/{id}','DashboardProductController@galleryDelete')->name('dashboard-products-gallery-delete');
